    ...
    <View style={styles.container}>
      <ScrollView
        ...
        <Text style={styles.text}>
          General Site Usage Last Revised: December 16, 2022 Welcome to
          https://app.gloversscorebook.com/. This site is provided as a service
          ...
          read them carefully. 1. YOUR AGREEMENT By using this Site, you agree
          to be bound by, and to comply with, these Terms and Conditions. If you
          do not agree to these Terms and Conditions, please do not use this
          site. PLEASE NOTE: We reserve the right, at our sole discretion, to
